...
struct GPUParam {
 public:
  ...
  float GetClusterRMS(int yz, int type, float z, float angle2) const;
  void GetClusterRMS2(int row, float z, float sinPhi, float DzDs, float& ErrY2, float& ErrZ2) const;

  float GetClusterError2(int yz, int type, float z, float angle2) const;
  void GetClusterErrors2(int row, float z, float sinPhi, float DzDs, float& ErrY2, float& ErrZ2) const;
  void UpdateClusterError2ByState(short clusterState, float& ErrY2, float& ErrZ2) const;
